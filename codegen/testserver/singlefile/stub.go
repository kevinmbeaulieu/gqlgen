...
type Stub struct {
	...
	QueryResolver struct {
		InvalidIdentifier                func(ctx context.Context) (*InvalidIdentifier, error)
		Collision                        func(ctx context.Context) (*It, error)
...
func (r *stubQuery) InvalidIdentifier(ctx context.Context) (*InvalidIdentifier, error) {
	return r.QueryResolver.InvalidIdentifier(ctx)
}
func (r *stubQuery) Collision(ctx context.Context) (*It, error) {
